...
public class FreePatchUtil {
    ...
    public static String patchFile="D:/增量包更新文件夹/patch.txt";//补丁文件,由eclipse svn plugin生成

    public static String projectPath="D:/eclipse-workspace/wuye";//项目文件夹路径

    public static String webContent="wuye";//web应用文件夹名

    public static String classPath="D:/eclipse-workspace/wuye/src";//class存放路径

    public static String desPath="D:/增量包更新文件夹/update_pkg20200630";//补丁文件包存放路径

    public static String version="20200630";//补丁版本
